...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[SpSpendTypeUserAdd]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[SpSpendTypeUserAdd]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.SpSpendTypeUserAdd
...
/*
	...
	EXEC [dbo].[SpSpendTypeUserAdd] @pUserId = '71722361-99FF-493F-AF02-2BD0ED7CE676', @pIncludeAll = 1
*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[SpSpendTypeUserAdd]
...
BEGIN TRY
	...
	IF NOT EXISTS (SELECT * FROM dbo.UserSpendType 
