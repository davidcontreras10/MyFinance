...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[SpSpendTypeDelete]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[SpSpendTypeDelete]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.SpSpendTypeDelete
...
/*
	...
	EXEC [dbo].[SpSpendTypeDelete]
*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[SpSpendTypeDelete]
...
BEGIN TRY
	...
	DELETE FROM dbo.UserSpendType WHERE SpendTypeId = @pSpendTypeId;
	DELETE FROM dbo.SpendType WHERE SpendTypeId = @pSpendTypeId;
