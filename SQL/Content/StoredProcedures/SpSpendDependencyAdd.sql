...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[SpSpendDependencyAdd]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[SpSpendDependencyAdd]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.SpSpendDependencyAdd
...
/*
	...
	BEGIN
		...
		EXEC SpSpendDependencyAdd @pLoanRecordIds=@pLoanRecordIds
	END

*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[SpSpendDependencyAdd]
@pSpendId INT,
@pDependencySpendId INT,
@pTwoWayDependency BIT = 1
AS
SET NOCOUNT ON
...
BEGIN TRY
	...
	INSERT INTO dbo.SpendDependencies (SpendId,DependencySpendId) VALUES (@pSpendId, @pDependencySpendId);
	IF @pTwoWayDependency = 1
	BEGIN
		INSERT INTO dbo.SpendDependencies (SpendId,DependencySpendId) VALUES (@pDependencySpendId, @pSpendId);
	END
