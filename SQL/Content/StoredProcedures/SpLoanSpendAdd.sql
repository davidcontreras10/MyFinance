...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[SpLoanSpendAdd]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[SpLoanSpendAdd]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.SpLoanSpendAdd
...
/*
	...
	exec SpLoanSpendAdd @pAccountPeriodId=1, @pUserId=N'test'
*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[SpLoanSpendAdd]
...
BEGIN TRY
	...
	INSERT INTO dbo.LoanSpend(LoanRecordId, SpendId) VALUES (@pLoanRecordId, @pSpendId);
