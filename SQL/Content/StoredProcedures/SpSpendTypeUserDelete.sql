...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[SpSpendTypeUserDelete]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[SpSpendTypeUserDelete]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.SpSpendTypeUserDelete
...
/*
	...
	EXEC [dbo].[SpSpendTypeUserDelete] @pUserId = '71722361-99FF-493F-AF02-2BD0ED7CE676', @pIncludeAll = 1
*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[SpSpendTypeUserDelete]
...
BEGIN TRY
	...
	IF EXISTS (SELECT * FROM dbo.UserSpendType 
		WHERE SpendTypeId = @pSpendTypeId AND UserId = @pUserId)
	BEGIN
		DELETE FROM dbo.UserSpendType WHERE SpendTypeId = @pSpendTypeId AND UserId = @pUserId;
		INSERT INTO @SpendTypesItems VALUES (@pSpendTypeId)
	END
