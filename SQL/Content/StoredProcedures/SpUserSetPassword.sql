...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[SpUserSetPassword]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[SpUserSetPassword]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.SpUserSetPassword
...
/*
	...
	exec SpUserSetPassword @pAccountPeriodIds=N'1,2', @pUserId = 'test'
*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[SpUserSetPassword]
...
BEGIN TRY
	...
	IF EXISTS (SELECT * FROM dbo.AppUser WHERE UserId = @pUserId)
	BEGIN
		UPDATE dbo.AppUser SET Password = @pPassword WHERE UserId = @pUserId;
	END	
	
	SELECT UserId FROM dbo.AppUser WHERE UserId = @pUserId
