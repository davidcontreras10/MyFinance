...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[SpLoanClose]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[SpLoanClose]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.SpLoanClose
...
EXEC SpLoanClose @pUserId = '71722361-99FF-493F-AF02-2BD0ED7CE676'

*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[SpLoanClose]
@pLoanRecordId INT
AS
SET NOCOUNT ON
...
BEGIN TRY
	...
	UPDATE dbo.LoanRecord SET LoanRecordStatusId = 2 WHERE LoanRecordId = @pLoanRecordId;
