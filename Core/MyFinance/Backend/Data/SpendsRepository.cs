...
using MyFinance.MyFinanceModel.Utilities;
...
namespace MyFinance.Backend.Data
{
	public class SpendsRepository : SqlServerBaseService, ISpendsRepository
	{
		...
		public SpendsRepository(IConnectionConfig connectionConfig, ICurrencyService currencyService, IMyFinanceSettings myFinanceSettings)
			: base(connectionConfig)
		{
			_currencyService = currencyService;
			_savingAmountTypeName = myFinanceSettings.SavingAmountTypeName;
			if (string.IsNullOrEmpty(_savingAmountTypeName))
				throw new MissingSettingException("SavingAmountTypeName");

			_spendAmountTypeName = myFinanceSettings.SpendAmountTypeName;
