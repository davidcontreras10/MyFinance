...
namespace MyFinance.MyFinanceModel
{
    ...
    public class ServiceException : Exception
    {
		...
		private int _errorCode = DefaultErrorCode;
		...
		public ServiceException(string message, int errorCode = DefaultErrorCode, HttpStatusCode statusCode = HttpStatusCode.InternalServerError)
            : base(message)
        {
            ErrorCode = errorCode;
    ...
    {   
			...
			: base(info, context)
		{
		    ...
		    item ??= info.GetSerializationEntry("ModelState");
		    if (item == null)
		    {
