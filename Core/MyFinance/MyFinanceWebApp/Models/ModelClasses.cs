...
using MyFinance.MyFinanceWebApp.CustomHandlers;
...
#pragma warning restore 649
        ...
        {
	        var internalCustomDate = JsonConvert.DeserializeObject<InternalCustomDate>(dateString);
            var customDate = new CustomDate(internalCustomDate._year, internalCustomDate._month,
    ...
    internal class BasicSpend : BaseModel
    {
        ...
        public static BasicSpend CreateBasicSpend(string jsonObject)
        {
            ...
            var basicSpend = JsonConvert.DeserializeObject<BasicSpend>(jsonObject);
            return basicSpend;
        }
    }
