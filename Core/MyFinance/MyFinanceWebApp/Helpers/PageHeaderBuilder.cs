...
namespace MyFinance.MyFinanceWebApp.Helpers
{
    public static class PageHeaderBuilder
    {
        ...
        public static MainHeaderModel GetHeader(IUrlHelper urlHelper, AppMenuItem activeMenuItem)
        {
        ...
        private static MenuItem GetSpendTypeMenuItem(bool active, IUrlHelper urlHelper)
        {
            return active
        ...
        private static MenuItem GetLoanMenuItem(bool active, IUrlHelper urlHelper)
        {
            return active
                ? (MenuItem)new DropDownMenuItem
                {
        ...
        private static MenuItem GetMyAccountMenuItem(bool active, IUrlHelper urlHelper)
        {
            return new DropDownMenuItem
            {
                ...
                Items = new MenuItem[]
                {
                    ...
                    new CustomLinkMenuItem {Name = "Log off", Link = urlHelper.Action("LogOff", "Auth")}
                }
            };
        }
    }
