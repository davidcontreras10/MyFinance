...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[SpDropTable]')
...
/*
	...
	exec SpDropTable @pUsername=N'test',@pSpendType=1,@pDate='2015-08-13 14:12:30',@pAmount=12, @pAccountPeriodIds='3,5'
*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[SpDropTable]
	@pdatabase NVARCHAR(50)=NULL,
	@ptable NVARCHAR(50)
AS
SET NOCOUNT ON
