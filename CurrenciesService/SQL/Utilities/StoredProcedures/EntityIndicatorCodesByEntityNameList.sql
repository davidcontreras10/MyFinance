...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[EntityIndicatorCodesByEntityNameList]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[EntityIndicatorCodesByEntityNameList]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.EntityIndicatorCodesByEntityNameList
...
--	parameters.
/*
	EXEC EntityIndicatorCodesByEntityNameList
	@pEntityName = '%Banco Promerica%'
*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[EntityIndicatorCodesByEntityNameList]
@pEntityName VARCHAR(500)
AS
SET NOCOUNT ON
...
SellCode VARCHAR(500),
PurchaseCode VARCHAR(500)
);
...
BEGIN TRY
	...
	INSERT INTO @EntityTemp (EntityName, SellCode, PurchaseCode)
	SELECT * FROM
	dbo.BccrWebServiceIndicator bccr
	WHERE bccr.EntityName LIKE @pEntityName
