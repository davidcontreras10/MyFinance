...
(
	SELECT	* 
	FROM	dbo.SYSOBJECTS 
	WHERE	Id = OBJECT_ID(N'[dbo].[EntityNameKeyByMethodIdList]')
	AND		OBJECTPROPERTY(Id, N'ISPROCEDURE') = 1
)
BEGIN
	DROP PROCEDURE [dbo].[EntityNameKeyByMethodIdList]
END
GO
--==============================================================================================================================================
--	Name:		 				dbo.EntityNameKeyByMethodIdList
...
--	parameters.
/*
	EXEC EntityNameKeyByMethodIdList
	@pMethodId = 1
*/
--==============================================================================================================================================
CREATE PROCEDURE [dbo].[EntityNameKeyByMethodIdList]
@pMethodId INT
AS
SET NOCOUNT ON
...
DECLARE @EntityTemp TABLE(
EntityName VARCHAR(500),
EntitySearchKey VARCHAR(500),
Colones BIT
);
...
BEGIN TRY
	...
	INSERT INTO @EntityTemp (EntityName, EntitySearchKey, Colones)
	SELECT TOP 1 etsp.EntityName, etsp.EntitySearchKey, mtsp.Colones FROM
	dbo.EntitiesSupported etsp
	JOIN dbo.MethodsSupported mtsp ON mtsp.EntitiesSupportedId = etsp.EntitiesSupportedId
	WHERE mtsp.MethodId = @pMethodId

	SELECT * FROM @EntityTemp;
