...
using WebApiBaseConsumer.Models;
...
namespace WebApiBaseConsumer
{
	...
	public class ServiceException : Exception
	{
			...
			: base(info.GetString("Message"), ExtractException(info))
		{
			...
			ErrorCode = DContre.MyFinance.StUtilities.StringUtilities.GetInt(errorCodeEntry.Value.Value);
			...
			StatusCode = (HttpStatusCode)DContre.MyFinance.StUtilities.StringUtilities.GetInt(statusCodeEntry.Value.Value);
		}
