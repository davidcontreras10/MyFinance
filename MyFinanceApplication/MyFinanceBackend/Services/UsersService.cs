...
namespace MyFinanceBackend.Services
{
    public class UsersService:IUsersService
	{
        ...
        public LoginResult AttemptToLogin(string username, string password)
        {
	        ...
	        var result = _userRespository.AttemptToLogin(username, encryptedPassword);
	        return result;
        }
	    ...
	    {
	        var userInfo = _userRespository.GetUserByUsername(request.Username);
	        if (userInfo == null)
	        {
	    ...
	    public bool ValidResetPasswordEmailRequest(ClientResetPasswordEmailRequest request)
	    {
	        ...
	        var user = _userRespository.GetUserByUsername(request.Username);
	    ...
	    public ResetPasswordValidationResult ValidateResetPasswordActionResult(string actionLink)
	    {
	        ...
	        var user = _userRespository.GetUserByUserId(token.UserId);
	    ...
	    public bool UpdateUser(string userId, ClientEditUser user)
	    {
	        ...
	        return _userRespository.UpdateUser(user);
	    }
